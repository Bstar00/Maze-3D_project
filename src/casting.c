...
{
        /** variables for ray, horizontal and vertical distance **/
...
/**
 * vertical_collision - function to check vertical collision
                        ...
                        int *vmtx)
{
        ...
        *vx = ray_x, *vy = ray_y;
        /** find the distance b/n the player and the ray hit the vertical line **/
