...
/**
 * init_instance -it  intializes all instance
...
int init_instance(SDL_Instance *in)
{
        ...
        /** creates the window with a given width & height **/
...
/**
 * FixAng - resets the angle if it is above the range
 * @a: the given angle
 *
