...
/**
 * poll_events - function to handle events poll
 * @ins: the instance of the SDL
 *
 * Return: 0 on suceesss 1 for failure
 **/
int poll_events(SDL_Instance ins)
{
        SDL_Event ev;

        /** while quit & escape key not pressed **/
...
/**
 * handle_door - function to handle the door open
 *
 * Return: nothing
 **/
