...
player_t player;
/**
 * display_player -the function to display player
...
{
        /** variables for the intial, final coordiantes and for SDL_rect **/
        SDL_Rect rect;
        float x0, y0, x1, y1;

        /** converts the player postion into map scale **/
...
void draw_floor(SDL_Instance ins, float ln_off, int n, float line, float ra)
{
        ...
        /** start from where the wall stops and draw the floor **/
...
void draw_roof(SDL_Instance ins, float ln_off, int n, float line, float ra)
{
        ...
        /** starts from the begining  to the wall and draw the ceiling **/
